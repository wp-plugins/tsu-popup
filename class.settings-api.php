 ...
 */
if ( !class_exists( 'TSU_Settings_API' ) ):
class TSU_Settings_API {
    ...
    /**
     * Displays a Normal Text field for a settings field
     *
     * @param array   $args settings field args
     */
    function callback_headline($args) {    
       
        $html .= sprintf( '<h3 style="color:#ff4000"> %s</h3>', $args['desc'] );
